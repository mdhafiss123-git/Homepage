...
export default function Footer() {
  return (
    <footer id="contact" className="bg-maroon-950 border-t border-gold-500/20 pt-14">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-10">
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="leading-tight">
              <span className="block font-display text-lg font-bold text-cream-50">D for Doubts</span>
          ...
          <div className="flex gap-3 mt-5">
            {SOCIALS.map((Icon, i) => (
              <a
                key={i}
                href="#social"
                className="w-9 h-9 rounded-full bg-cream-50/5 flex items-center justify-center text-cream-100/70 hover:bg-gold-500 hover:text-maroon-950 transition-colors"
        ...
        <div>
          <h4 className="font-display font-semibold text-cream-50 mb-4">Quick Links</h4>
          <ul className="space-y-2.5">
            {FOOTER_LINKS.quick.map((link) => (
              <li key={link}>
                <a href="#" className="text-cream-100/60 text-sm hover:text-gold-400 transition-colors">
                  {link}
                </a>
              </li>
            ))}
        ...
        <div>
          <h4 className="font-display font-semibold text-cream-50 mb-4">Popular Courses</h4>
          <ul className="space-y-2.5">
        ...
        <div>
          <h4 className="font-display font-semibold text-cream-50 mb-4">Contact Us</h4>
          <ul className="space-y-3 text-sm text-cream-100/60">
            ...
            <li className="flex items-center gap-2">
              <MapPin size={15} className="text-gold-400 shrink-0" /> Bangalore, Karnataka, India
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-gold-500/10 py-5 px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-3 max-w-7xl mx-auto">
        <p className="text-cream-100/40 text-xs">© 2026 D for Doubts. All rights reserved.</p>
        <div className="flex gap-5 text-xs text-cream-100/40">
